...
! function (t, e) {
  ...
  class Xe extends R {
    ...
    setElementContent(t, e) {
      if (null !== t) return a(e) ? (e = l(e), void(this._config ? e.parentNode !== t && (t.innerHTML = "", t.appendChild(e)) : t.textContent = e.textContent)) : void(this._config ? (this._config.sanitize && (e = qe(e, this._config.allowList, this._config.sanitizeFn)), t.innerHTML = e) : t.textContent = e)
    }
    getTitle() {
