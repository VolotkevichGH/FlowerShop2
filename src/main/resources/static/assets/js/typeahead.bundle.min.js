        ...
        h = function () {
            ...
            return i = {
                ...
                _renderSuggestions: function (a, b) {
                    var c;
                    c = this._getSuggestionsFragment(a, b), this.$lastSuggestion = c.children().last(), this.$el(c).prepend(this._getHeader(a, b)).append(this._getFooter(a, b))
                },
                ...
                _renderPending: function (a) {
                    ...
                    this._resetLastSuggestion(), b && this.$el(b({
                        query: a,
                        dataset: this.name
                    }))
                },
        ...
        o = a.fn.typeahead, p = {
            ...
            initialize: function (e, l) {
                function m() {
                    ...
                    }), c = a(this), m = a(o.wrapper), q = n(e.hint), r = n(e.menu), s = e.hint !== !1 && !q, t = e.menu !== !1 && !r, s && (q = f(c, o)), t && (r = a(o.menu).css(o.css.menu)), q && q.val(""), c = h(c, o), (s || t) && (m.css(o.css.wrapper), c.css(s ? o.css.input : o.css.inputWithNoHint), c.wrap(m).parent().prepend(s ? q : null).append(t ? r : null)), y = t ? j : i, u = new d({
                        el: c
                    }), v = new g({
                        hint: q,
                        input: c
